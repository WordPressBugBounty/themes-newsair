...
class Responsive_slider_control extends WP_Customize_Control {
	...
	public function enqueue(){
      ...
      wp_enqueue_script('responsive_slider_control_js', get_template_directory_uri().'/inc/ansar/custom-control/responsive_slider_control/js/responsive_slider_control.js', array('jquery'),'4.0.13' , true );
